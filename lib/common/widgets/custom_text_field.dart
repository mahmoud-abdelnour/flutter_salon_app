      ...
      if(widget.title?.isNotEmpty ?? false)...[
        RichText(text: TextSpan(children: [
          ...
          if(widget.isRequired)
            TextSpan(
              text: '*',
              style: almaraiBold.copyWith(color: Theme.of(context).colorScheme.error),
            ),
        ...
        Container(
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                color: widget.isElevation ? Colors.grey[200]! : Colors.transparent,
                spreadRadius: 0.5,
                blurRadius: 0.5,
          ...
          child: TextFormField(
            ...
            decoration: InputDecoration(
              ...
              hintStyle: almaraiBold.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).hintColor.withOpacity(0.6)),
              filled: true,
                  ...
                  ? widget.isPassword
                      ...
                      : widget.isIcon
                          ? IconButton(
                              ...
                              icon:  Icon(widget.suffixIconUrl, color: Theme.of(context).hintColor.withOpacity(0.6)),
                            )
